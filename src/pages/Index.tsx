...
${body}`);
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Стандартная утилизация занимает 5-7 рабочих дней с момента получения оборудования. Экспресс-утилизация доступна в течение 1-2 дней за дополнительную плату."
    },
    {
    ...
    {
      question: "Возможна ли утилизация оборудования на территории клиента?",
      answer: "Да, мы предоставляем услугу утилизации на месте для крупных партий оборудования (от 100 единиц). Наши специалисты приедут со всем необходимым оборудованием."
    },
    {
