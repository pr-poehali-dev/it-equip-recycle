...
export default function Clients() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-professional-rolexGreen via-professional-rolexGreen/95 to-professional-rolexGreen/90">
      {/* Hero секция */}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-professional-rolexGold/20 rounded-full mb-6">
              <Icon name="Award" size={32} className="text-professional-rolexGold" />
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
              Нам доверяют
            </h1>
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Ведущие российские компании из различных отраслей экономики выбирают нас для решения задач утилизации
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 max-w-7xl mx-auto mb-12">
            {clients.slice(0, showAll ? clients.length : 12).map((client, index) => (
              <div 
                key={index} 
                onClick={() => handleClientClick(client)}
                className={`${client.fill ? 'p-0 overflow-hidden' : 'flex items-center justify-center p-4'} ${(client.name === 'ООО СИБУР' || client.name === 'METRO Cash & Carry') ? 'p-2' : client.fill ? 'p-0' : 'p-4'} bg-white/95 backdrop-blur-sm border-2 border-professional-rolexGold/30 rounded-lg hover:shadow-xl hover:border-professional-rolexGold hover:bg-white transition-all duration-300 hover:scale-105 group aspect-square cursor-pointer`}
              >
                <img 
                  src={client.logo} 
          ...
          {!showAll && (
            <div className="text-center mb-16">
              <Button 
                ...
                className="bg-professional-rolexGold hover:bg-professional-rolexGold/90 text-professional-rolexGreen font-semibold px-8 py-3 text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
                Показать остальных
              </Button>
            </div>
      ...
      <section className="pb-20">
        <div className="container mx-auto px-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 lg:p-12 max-w-6xl mx-auto border border-professional-rolexGold/30">
            <div className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-2xl mx-auto">
                Наши преимущества, которые ценят крупнейшие компании России
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center group">
                <div className="bg-professional-rolexGold/20 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <span className="text-3xl">🏆</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-4">Проверенное качество</h3>
                <p className="text-white/80 leading-relaxed">
                  Работаем с крупнейшими компаниями России с 2013 года
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Полный комплаенс</h3>
                <p className="text-white/80 leading-relaxed">
                  Соответствие всем требованиям корпоративного документооборота
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Конфиденциальность</h3>
                <p className="text-white/80 leading-relaxed">
                  Гарантированное уничтожение данных с носителей информации
                </p>
              </div>
              
              <div className="text-center group">
                <div className="bg-professional-rolexGold/20 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Icon name="Clock" size={32} className="text-professional-rolexGold" />
                </div>
                <h3 className="text-xl font-bold text-white mb-4">Экономия времени</h3>
                <p className="text-white/80 leading-relaxed">
                  Время — самый ценный ресурс. Мы берём на себя все заботы по утилизации
                </p>
              </div>
            </div>
          </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="max-w-2xl bg-white border-2 border-professional-rolexGold/30">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-professional-rolexGreen mb-4">
              {selectedClient?.name}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-6">
            <div className="flex justify-center">
              <div className="w-32 h-32 bg-gray-50 border-2 border-professional-rolexGold/20 rounded-lg p-4 flex items-center justify-center">
                <img 
