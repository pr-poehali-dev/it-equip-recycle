...
export default function ClientsSection() {
  const clients = [
    ...
    { name: "М.Видео", logo: "/img/036d9212-e237-4bcf-8186-c6393760c295.jpg", fill: true },
    { name: "Газпром", logo: "/img/d6f16df7-aec0-47e2-8d51-57ca9421d988.jpg", fill: true },
    { name: "РЖД", logo: "/img/220bd1ee-2ea5-4efc-b1c2-ed866ca85feb.jpg", fill: true },
