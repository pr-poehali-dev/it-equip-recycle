      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="section-title text-center text-gray-900 mb-4">
            <span className="text-green-600">Как мы работаем:</span> последовательность шагов
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">Получаем ваш список отходов</h3>
            ...
            <div className="text-center">
              <div className="bg-gray-100 p-4 rounded-lg mb-4">
                <Icon name="FileCheck" size={32} className="mx-auto text-gray-600" />
              </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-gray-900 mb-2">Забираем отходы с вашей территории</h3>
              <p className="text-sm text-gray-600">
