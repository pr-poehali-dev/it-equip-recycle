      ...
      <section className="pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-professional-rolexGold/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                ...
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="font-bold text-white text-lg">ЗДРАВООХРАНЕНИЕ</span>
                  </div>
                  <ul className="space-y-2 text-white/90">
                ...
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="font-bold text-white text-lg">КУЛЬТУРА</span>
                  </div>
                  <ul className="space-y-2 text-white/90">
                ...
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="font-bold text-white text-lg">ЖКХ</span>
                  </div>
                  <ul className="space-y-2 text-white/90">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="font-bold text-white text-lg">ОРГАНИЗАЦИИ</span>
                  </div>
                  <ul className="space-y-2 text-white/90">
                ...
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="font-bold text-white text-lg">МАГАЗИНЫ</span>
                  </div>
                  <ul className="space-y-2 text-white/90">
                ...
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="font-bold text-white text-lg">СЕРВИСНЫЕ КОМПАНИИ</span>
                  </div>
                  <ul className="space-y-2 text-white/90">
                ...
                <div className="bg-white/10 rounded-lg p-6 border border-professional-rolexGold/20">
                  <div className="flex items-center mb-4">
                    ...
                    <span className="font-bold text-white text-lg">HORECA</span>
                  </div>
                  <ul className="space-y-2 text-white/90">
